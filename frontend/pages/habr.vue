    ...
    <div class="community">
      <div class="community__content">
        <div class="community__header">
          ...
          <div class="community__label">Топ 30 тегов с хабра</div>
        </div>
        <!-- <input placeholder="Введите название сообщества..." type="text" /> -->
  
        <div style="margin:30px 0;display: block;overflow:auto;height: 480px;">
          <table class="table table-dark" >
            <thead>
              <tr>
                <th scope="col">#</th>
                <th scope="col">Название тега</th>
                <th scope="col">Количество упоминаний</th>
              </tr>
            </thead>
